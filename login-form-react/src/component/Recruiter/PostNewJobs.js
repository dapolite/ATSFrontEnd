                ...
                <Col className="resume-page1">
                    <Col>
                        ...
                        <Row>
                            <Col>
                                <div className="resume1">
                                    <input className="input13" placeholder="Job Title" readOnly></input>
                                </div>
                        ...
                        <Row>
                            <Col>
                                <div className="resume1">
                                    <input className="input13" placeholder="Job Description" readOnly></input>
                                </div>
                        ...
                        <Row>
                            <Col>
                                <div className="resume1">
                                    <input className="input13" placeholder="Responsibilities" readOnly></input>
                                </div>
                        ...
                        <Row>
                            <Col>
                                <div className="resume1">
                                    <input className="input13" placeholder="Other Benefits" readOnly></input>
                                </div>
                        ...
                        <Row>
                            <Col>
                                <div className="resume1">
                                    <input className="input13" placeholder="About Company" readOnly></input>
                                </div>
