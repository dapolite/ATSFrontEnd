...
*/
   ...
   handleSubmit = event =>{
       console.log(this.state.candidate_fathername)
                                ...
                                <Row>
                                    <Col>
                                        ...
                                        <div className="resume2">
                                            <input className="input1" placeholder="Please Enter Your Name" name="candidate_fullname" value={candidate_fullname} onChange={this.changeHandler.bind(this)}></input>
                                        </div>
                                    </Col>
                                </Row>
                                <br/><br/>
                                ...
                                <Row key={i}>
                                    <Col>
                                        ...
                                        <Card className="resume2 border-0">
                                            ...
                                            <Row>   
                                                <Col>
                                                    <input className="input1-noi" placeholder="Job Company" name="experienceCompanyname" value={experienceCompanyname} onChange={this.changeHandler.bind(this, i)}></input>
                                                </Col>
